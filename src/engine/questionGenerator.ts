...
function makeDietQuestion(specimen: Specimen, _pool: Specimen[], choices: number): Question | null {
  ...
  return {
    ...
    category: 'diet',
    specimen,
    text: `What did the ${specimen.name} eat?`,
    choices: ch,
    correctIndex,
...
function makeFunFactQuestion(specimen: Specimen): Question {
  ...
  return {
    ...
    category: 'fun-fact',
    specimen,
    text: `True or false: "${specimen.funFact}"`,
    choices,
    correctIndex,
...
function makeArtifactUse(specimen: Specimen, pool: Specimen[], choices: number): Question | null {
  ...
  return {
    ...
    specimen,
    text: `What was a ${specimen.name} used for?`,
    choices: ch,
    correctIndex,
...
function makeDiscoveryQuestion(specimen: Specimen, pool: Specimen[], choices: number): Question | null {
  ...
  return {
    ...
    category: 'discovery',
    specimen,
    text: `In which country was the ${specimen.name} first discovered?`,
    choices: ch,
    correctIndex,
